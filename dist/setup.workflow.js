...
const setWebhook = node({
  ...
  config: {
    ...
    parameters: {
      method: 'POST',
      url: 'https://api.telegram.org/bot__TELEGRAM_BOT_TOKEN__/setWebhook',
      sendBody: true,
      contentType: 'json',
      specifyBody: 'json',
      jsonBody: '{"url": "https://your-n8n.example.com/webhook/takhfif-finder-bot", "secret_token": "__WEBHOOK_SECRET__", "allowed_updates": ["message", "callback_query", "my_chat_member"], "drop_pending_updates": true, "max_connections": 40}',
...
const setCommands = node({
  ...
  config: {
    ...
    parameters: {
      method: 'POST',
      url: 'https://api.telegram.org/bot__TELEGRAM_BOT_TOKEN__/setMyCommands',
      sendBody: true,
      contentType: 'json',
      specifyBody: 'json',
...
const setDescription = node({
  ...
  config: {
    ...
    parameters: {
      method: 'POST',
      url: 'https://api.telegram.org/bot__TELEGRAM_BOT_TOKEN__/setMyDescription',
      sendBody: true,
      contentType: 'json',
      specifyBody: 'json',
...
const setShortDescription = node({
  ...
  config: {
    ...
    parameters: {
      method: 'POST',
      url: 'https://api.telegram.org/bot__TELEGRAM_BOT_TOKEN__/setMyShortDescription',
      sendBody: true,
      contentType: 'json',
      specifyBody: 'json',
...
const webhookInfo = node({
  ...
  config: {
    name: 'Webhook Info',
    position: [1200, 300],
    parameters: { method: 'GET', url: 'https://api.telegram.org/bot__TELEGRAM_BOT_TOKEN__/getWebhookInfo', options: { response: { response: { neverError: true } } } }
  }
});
